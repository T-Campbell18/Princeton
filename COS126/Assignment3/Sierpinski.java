 ...
 * Partner Precept: N/A
 * 
 * Description: plots a Sierpinski triangle(Polish mathematician Wacław 
 * Sierpiński described the pattern in 1915) of order n to standard drawing
 * using recursion that draws 3 new triangles every time it calls itself
 *
 ******************************************************************************/
